...
function showUserPopup() {
    Swal.fire({
        title: 'Not Allowed',
        text: 'You are not allowed to add user currently',
        icon: 'warning',
        background: '#212121',
        color: '#ffffff',
...
//     const content = `
//         <div>
//             <h4 class="text-white font-bold">Top by Sales</h4>
//             <p class="text-white">Details of top sales performers...</p>
//             <button class="text-[#2196F3]">View Profile</button>
//         </div>
//         <div class="mt-4">
//             <h4 class="text-white font-bold">Top by Meetings</h4>
//             <p class="text-white">Details of top meeting performers...</p>
//             <button class="text-[#2196F3]">View Profile</button>
//         </div>
//     `;
//     document.getElementById('popupContent').innerHTML = content;
//     document.getElementById('viewAllPopup').classList.remove('hidden');
// }

// function closeViewAllPopup() {
//     document.getElementById('viewAllPopup').classList.add('hidden');
// }

// function viewProfile(performer) {
//     // Logic to view profile
//     alert('Viewing profile for ' + performer);
// }
function openViewAllPopup() {
